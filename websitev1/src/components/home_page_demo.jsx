...
import "./styles/home_page_demo.css";
...
let HomePageDemo = () => {
    ...
    <div className="home-page-demo-container">
        ...
        <canvas ref={canvasRef} className="home-page-demo-canvas"></canvas>

        {
            showHero &&
            <>
            
                <h1 className={heroVisible ? 'hero-in' : 'hero-out'}>Raziel Moesch</h1>
                <h2 className={heroVisible ? 'hero-in hero-delay' : 'hero-out'}>Software Engineer</h2>
...

        {
            ...
            <>
                ...
                <div className="control-panel">
                    ...
                    <label className="checkbox-label">
                        <input type="checkbox" checked={showHero} onChange={(e) => setShowHero(e.target.checked)} /> Show Hero
                    </label>
                    <label className="checkbox-label">
